...
from helios.components.data_loader import RandomVideoDataset
from helios.utils.general_utils import RecursiveAverageMeter, map_dict
from helios.components.checkpointer import CheckpointHandler, save_cmd, save_git, get_config_path
from helios.utils.general_utils import dummy_context, AttrDict, get_clipped_optimizer, \
                                                        AverageMeter, ParamDict
from helios.utils.pytorch_utils import LossSpikeHook, NanGradHook, NoneGradHook, \
                                                        DataParallelWrapper, RAdam
from helios.components.trainer_base import BaseTrainer
...
class ModelTrainer(BaseTrainer):
    ...
    def _default_hparams(self):
        default_dict = ParamDict({
            ...
            'optimizer': 'radam',    # supported: 'adam', 'adamw', 'radam', 'rmsprop', 'sgd'
            # 'optimizer': 'adamw',    # supported: 'adam', 'adamw', 'radam', 'rmsprop', 'sgd'
            'lr': 1e-3,
            'gradient_clip': None,
