...
from helios.utils.general_utils import ParamDict, AttrDict, map_recursive
from helios.utils.pytorch_utils import ar2ten, ten2ar
...
class BaseEnvironment:
    ...
    def _default_hparams(self):
        default_dict = ParamDict({
            ...
            'screen_width': 512,     # width of rendered images
            'screen_height': 512,    # height of rendered images
        })
        return default_dict
