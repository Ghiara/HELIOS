...
from helios.utils.general_utils import AttrDict, map_dict, maybe_retrieve, shuffle_with_seed
from helios.utils.pytorch_utils import RepeatedDataLoader
from helios.utils.video_utils import resize_video
...
class Dataset(data.Dataset):
    ...
    def __init__(self, data_dir, data_conf, phase, shuffle=True, dataset_size=-1):
        ...
        self.n_worker = 12 if shuffle else 1 # fit to your machine
