...
from helios.utils.general_utils import AttrDict, split_along_axis
from helios.data.block_stacking.src.utils.utils import quat2euler
from helios.data.block_stacking.src.block_stacking_env import BlockStackEnv
...
if __name__ == "__main__":
    from helios.data.block_stacking.src.block_task_generator import SingleTowerBlockTaskGenerator
    obs = AttrDict(
