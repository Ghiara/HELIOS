...
from helios.components.base_model import BaseModel
from helios.components.logger import Logger
from helios.components.checkpointer import load_by_key, freeze_modules
from helios.modules.losses import KLDivLoss, NLL
from helios.modules.subnetworks import BaseProcessingLSTM, Predictor, Encoder
from helios.modules.recurrent_modules import RecurrentPredictor
from helios.utils.general_utils import AttrDict, ParamDict, split_along_axis, get_clipped_optimizer
from helios.utils.pytorch_utils import map2np, ten2ar, RemoveSpatial, ResizeSpatial, map2torch, find_tensor, \
                                        TensorModule, RAdam
from helios.utils.vis_utils import fig2img
from helios.modules.variational_inference import ProbabilisticModel, Gaussian, MultivariateGaussian, get_fixed_prior, \
                                                mc_kl_divergence
from helios.modules.layers import LayerBuilderParams
from helios.modules.mdn import MDN, GMM
from helios.modules.flow_models import ConditionedFlowModel
...
class SkillPriorMdl(BaseModel, ProbabilisticModel):
    ...
    def _default_hparams(self):
        ...
        default_dict.update({
            ...
            'nz_mid_gru': 128,          # size of middle GRU layers (optional)
            'n_gru_layers': 2,          # number of GRU layers (optional, default 2)
